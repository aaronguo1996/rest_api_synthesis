...
class Type:
    ...
    def of_array_type(self, obj, expected_type):
        ...
        if array_type:
            ...
            if item_schema is not None:
                field_type = Type(self.name, item_schema)
            else:
    ...
    def is_type_of(self, obj):
        ...
        try:
            ...
            if Type.is_array_type(expected_type):
                return self.of_array_type(obj, expected_type)

            if Type.is_union_type(expected_type):
                # print("checking union type")
    ...
    def infer_type_for(path_to_defs, skip_fields, value):
        ...
        obj_defs = Type.get_object_def(path_to_defs)
        obj_candidates = []
