from apiphany.benchmarks.benchmark import Benchmark, BenchmarkSuite
from apiphany.schemas import types
from apiphany.program.program import (Program, ProjectionExpr, EquiExpr,
...
slack_suite = BenchmarkSuite(
    "apiphany/configs/slack_config.json",
    "slack",
    slack_benchmarks
)
...
stripe_suite = BenchmarkSuite(
    "apiphany/configs/stripe_config.json",
    "stripe",
    stripe_benchmarks
)
...
square_suite = BenchmarkSuite(
    "apiphany/configs/square_config.json",
    "squareapi",
    square_benchmarks
)